...
This repository contains HashiCorp Terraform configuration required to create a Azure AKS cluster.  The scripts directory contains the bash scripts to set-up the MongoDb-Operator on Azure
...
```bash
git clone https://github.com/johndohoneyjr/Azure-MongoDB-Kubernetes-Operator-Demo
```

## Azure Security Principal creation
